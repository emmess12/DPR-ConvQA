...
with open('convqa/topiocqa/preprocessed/retriever/train_answer_6_hisContra.json') as json_file:
...
with open('convqa/topiocqa/preprocessed/qa/train_answer_6.json', "w") as writer: 
