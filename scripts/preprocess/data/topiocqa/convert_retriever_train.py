...
with open('convqa/topiocqa/original/original/topiocqa_train.json') as json_file, open('densephrases-data/convqa/topiocqa/original/all_history/train.json') as all_history_json_file:
...
with open('convqa/topiocqa/preprocessed/retriever/train_answer_'+str(window_size)+'_hisContra.json', "w") as writer: 
