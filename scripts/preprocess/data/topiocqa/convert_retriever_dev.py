...
with open('convqa/topiocqa/original/original/topiocqa_dev.json') as json_file, open('densephrases-data/convqa/topiocqa/original/all_history/dev.json') as all_history_json_file:
...
with open('convqa/topiocqa/preprocessed/retriever/dev_answer_'+str(window_size)+'_hisContra.json', "w") as writer: 
