...
with open('convqa/orquac/original/quac_format/test.txt') as json_file:
...
with open('convqa/orquac/preprocessed/retriever/test_answer_'+str(window_size)+'_hisContra.json', "w") as writer: 
