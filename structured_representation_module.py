...
from dpr.question_understanding.question_understanding import QuestionUnderstanding
from dpr.question_understanding.structured_representation.structured_representation_model import (
    StructuredRepresentationModel,
)
import dpr.question_understanding.structured_representation.dataset_structured_representation as dataset
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        raise Exception(
            "Usage: python dpr/question_understanding/structured_representation/structured_representation_module.py --<FUNCTION> <PATH_TO_CONFIG>"
        )
