...
class StructuredRepresentationModel(torch.nn.Module):
    ...
    def train(self, train_path, dev_path):
        ...
        training_args = transformers.Seq2SeqTrainingArguments(
            output_dir="dpr/question_understanding/structured_representation/results",  # output directory
            ...
            logging_dir="dpr/question_understanding/structured_representation/logs",  # directory for storing logs
            logging_steps=1000,
